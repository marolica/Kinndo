(() => {
  const clubs = [
    ...
    { id: 'cooking', name: 'Cooking Class', emoji: '👨‍🍳', cadence: '3 sessions · monthly', img: 'supper-club.png',
      about: 'One great recipe, one shared table. You guide the kitchen — and people leave with full stomachs and the kind of conversation small talk never reaches.' },
    { id: 'reading', name: 'Reading Club', emoji: '📚', cadence: '3 sessions · monthly', img: 'book-club.png',
      about: 'One book, one evening, real conversation. You set the reading and host the kind of discussion people clear their calendar for — and leave thinking about for days.' },
  ...
  const steps = [
    { n: '01', icon: 'clipboard-list', title: 'You raise your hand' },
    { n: '02', icon: 'video', title: 'We meet you' },
    { n: '03', icon: 'palette', title: 'You design your club' },
    { n: '04', icon: 'users-round', title: 'We curate your people' },
    { n: '05', icon: 'sparkles', title: 'You host' },
    { n: '06', icon: 'trending-up', title: 'They come back' },
  ];
  ...
  function renderResponsibilities() {
    ...
    if (list) list.innerHTML = responsibilities.map(r => `
